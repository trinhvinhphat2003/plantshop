        ...
        <div class="container" id="detail-content">
            <div class="row" style="margin-top: 20px">
                <div class="col-4" style="display: flex;flex-direction: column;text-align: center;gap: 20px;">
                    <h1 style="overflow: hidden;width: 100%;height: 50px;">thank for your order</h1>
                    <span>Order date: ${order.getOrdDate()}</span>
                    <span>Ship date: ${order.getShipdate()}</span>
                    <h4 style="overflow: hidden;">Total: ${total} VND</h4>
                    <a href="home">Home</a>
                    <a href="shopping">Continue Buying</a>
                </div>
                    ...
                    <table class="table-bordered">
                        ...
                        <c:forEach items="${listItem}" var="item">
                            <tr>
                                ...
                                <td>${item.getQuantity() * item.plant.price}</td>
