                            ...
                            <tbody>
                                <c:forEach items="${listItem}" var="item">
                                    <tr>
                                        ...
                                        <td >
                                            <form action="admin-AccountManaging" method="post">
                                                
                                                <c:if test="${item.getStatus() == 1}">
                                                    <button type="submit" value="block" name="action" class="btn btn-primary btn-danger ">Block</button>
                                                </c:if>
                                                <c:if test="${item.getStatus() == 0}">
                                                    <button type="submit" value="unblock" name="action" class="btn btn-primary btn-danger ">Unblock</button>
                                                </c:if>
                                                    <input type="hidden" name="id" value="${item.getAccID()}">
                                            </form>
