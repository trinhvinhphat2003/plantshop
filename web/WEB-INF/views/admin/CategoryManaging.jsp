        ...
        <main>
            <div class="container-fluid" id="content-con">
                <div class="row flex-nowrap">
                    ...
                    <div class="col py-3">
                        <form action="admin-CategoryManaging" method="post" class="row" style="display: flex;gap: 20px;flex-direction: row-reverse;margin-right: 20px;">
                            
                            <input type="text" required="" name="category" style="width: 200px;height: 38px;border-radius: 5px">
                            ...
                            <tbody>
                                <c:forEach items="${listItem}" var="item">
                                    <tr>
                                        ...
                                        <td>
                                            <form action="admin-CategoryManaging" method="post" style="align-items: center;display: flex;gap: 10px">
                                                <button type="submit" name="action" value="edit" class="btn btn-primary btn-danger ">edit</button>
                                                <input type="" required="" placeholder="edit category" name="newCategory" style="height: 38px; border-radius: 5px">
                                                <input type="hidden" name="id" value="${item.getCateID()}">
                                            </form>
